...
public:
    ...
    void setupUi(QWidget *Hud)
    {
        ...
        horizontalLayoutWidget->setGeometry(QRect(10, 10, 201, 25));
        ...
        horizontalLayoutWidget_2->setGeometry(QRect(10, 50, 201, 25));
        ...
        horizontalLayoutWidget_3->setGeometry(QRect(10, 90, 201, 25));
        ...
        horizontalLayoutWidget_4->setGeometry(QRect(10, 130, 201, 25));
        ...
        horizontalLayoutWidget_5->setGeometry(QRect(10, 170, 201, 25));
        ...
        horizontalLayoutWidget_6->setGeometry(QRect(10, 210, 201, 25));
